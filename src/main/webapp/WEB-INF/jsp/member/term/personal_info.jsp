...
Cookie new Cookie (이하 ‘회사’)는 이용자의 ‘동의를 기반으로 개인정보를 수집·이용 및 제공’ 하고 있으며, ‘이용자의 권리(개인정보 자기결정권)를 적극적으로 보장’ 합니다.
...
①개인정보 수집 항목 : 이름, 아이디, 비밀번호, 이메일

②서비스 이용 항목 : 서비스 이용기록, 접속 로그, 쿠키, IP 주소, 결제기록, 회원조치기록


선택적으로 수집하는 정보

①개인정보 수집 항목 : 성별, 생년월일, 본인확인값(DI)
...
회원님이 데이터 삭제 요청을 문의게시판 또는 사이트 하단에 표기된 이메일로 하실수 있습니다.
...
②개인정보보호협회 (www.eprivacy.or.kr / 02-550-9500)

③대검찰청 사이버범죄신고 (spo.go.kr / 1301)
